...
export default function Feedback() {
  ...
  return <div className={`workspace feedback-workspace ${current ? 'has-selection' : ''}`}>
    <section className="workspace-list">
      <div className="workspace-heading"><h3>{admin ? 'Feedback inbox' : 'My feedback'}</h3><button className="icon-button" title="Send feedback" aria-label="Send feedback" onClick={() => { setError(''); setCompose(true) }}><Plus size={20}/></button></div>
