...
export default function CalendarPage(){
  const {settings,refreshKey}=useApp(); const [cursor,setCursor]=useState(displayDate(new Date())); const [data,setData]=useState({}); const [selected,setSelected]=useState(null); const [txs,setTxs]=useState([])
