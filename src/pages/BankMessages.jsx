...
export default function BankMessages() {
  ...
  return <div className="stack gap-18">
    ...
    <section className="panel glass"><div className="section-row"><h3>Phone forwarding</h3><span>{enabled ? 'Key active' : 'Off'}</span></div>
      ...
      <p className="muted">Requires a phone automation. Only forward transaction alerts; exclude verification codes. A forwarding key can add messages to this account but cannot read your data.</p>
    </section>
