...
export default function Settings(){
  ...
  return <div className="settings-grid">
    ...
    <SettingsSection title="Personal preferences" className=""><form onSubmit={save} className="stack gap-16">
      ...
      {form.reminders_enabled && <><label className="field"><span>Reminder time (Kuwait)</span><input required type="time" value={form.reminder_time || '20:00'} onChange={e => setForm({...form, reminder_time:e.target.value})}/></label><NotificationPreferences form={form} setForm={setForm}/></>}
